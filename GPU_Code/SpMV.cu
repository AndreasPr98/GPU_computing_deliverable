...
int main(int argc, char *argv[]) {
    ...
    std::filesystem::directory_entry entry(matrix_files[(size_t)requested_matrix_number - 1]);
        ...
        results.coo_bw_effective_gbs = ns_to_gbs(coo_effective_bytes(COO_matrix), results.coo_time_ns);
        ...
        results.coo_parallel_bw_effective_gbs = ns_to_gbs(coo_effective_bytes(COO_matrix), results.coo_parallel_time_ns);
        ...
        results.csr_bw_effective_gbs = ns_to_gbs(csr_effective_bytes(CSR_matrix), results.csr_time_ns);
        ...
        results.csr_parallel_bw_effective_gbs = ns_to_gbs(csr_effective_bytes(CSR_matrix), results.csr_parallel_time_ns);
        ...
        results.coo_cuda_basic_bw_gbs = ns_to_gbs(coo_effective_bytes(COO_matrix), results.coo_cuda_basic_time_ns);
        ...
        results.coo_cuda_custom_1_bw_gbs = ns_to_gbs(coo_effective_bytes(COO_matrix), results.coo_cuda_custom_1_time_ns);
        ...
        results.coo_cuda_cuSparse_bw_gbs = ns_to_gbs(coo_effective_bytes(COO_matrix), results.coo_cuda_cuSparse_time_ns);
        ...
        results.csr_cuda_basic_bw_gbs = ns_to_gbs(csr_effective_bytes(CSR_matrix), results.csr_cuda_basic_time_ns);
        ...
        results.csr_cuda_custom_1_bw_gbs = ns_to_gbs(csr_effective_bytes(CSR_matrix), results.csr_cuda_custom_1_time_ns);
        ...
        results.csr_cuda_custom_2_bw_gbs = ns_to_gbs(csr_effective_bytes(CSR_matrix), results.csr_cuda_custom_2_time_ns);
        ...
        results.csr_cuda_cuSparse_bw_gbs = ns_to_gbs(csr_effective_bytes(CSR_matrix), results.csr_cuda_cuSparse_time_ns);
